...
class countryAbbreviation(str, Enum):
    """
    contains country names and 2- 3- characters Alpha code as well as Numeric code
    source: source: https://www.iban.com/country-codes
    """
